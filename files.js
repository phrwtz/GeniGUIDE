        ...
        reader.onloadend = (function (f) {
            return function (e) {
                ...
                for (let i = 2; i < data.length; i++) {
                    let userId = data[i][5];
                    if (typeof newStudentsObj[userId] != "undefined") {
                        newStudent = newStudentsObj[userId];
                    } else {
                        newStudent = new Object();
                    }
                    for (let r = 15; r < header.length; r++) {
                        questions.push(header[r])
                    };
